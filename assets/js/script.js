    ...
    $(document).ready(function(){
        ...
        function testNmb(){
            if($gameSearch == $gameValue){
                ...
                $('#gameReset').show(); // On affiche le btn reset
            }else{
                if($gameSearch > $gameValue){
                    $gameResult.text('Pouet, c\'est moins !');// Si le nombre entré est supérieur au nombre attendu
                }else{
                    $gameResult.text('Pouet, c\'est plus !');// Si le nombre entré est inférieur au nombre attendu
                }
            }
        }
    });
